    ...
    def __init__(
        ...
        *,
        ...
        for data in read_file(path):
            ...
            # Add "label" field to metadata if it exists (for honesty training)
            if "label" in data and data["label"] is not None:
                metadata["label"] = data["label"]

            # Add "missing_conditions" field to metadata if it exists (for MAE honesty training)
            if "missing_conditions" in data and data["missing_conditions"] is not None:
                metadata["missing_conditions"] = data["missing_conditions"]
